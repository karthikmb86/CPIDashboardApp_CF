		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "CPIDashboardApp",
									"targetURL": "#sapbtpcpidashboard-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sapbtpcpidashboard-display": {
								"semanticObject": "sapbtpcpidashboard",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sap.btp.cpidashboard",
									"url": sap.ui.require.toUrl("sap/btp/cpidashboard")
								}
							}
						}
					}
